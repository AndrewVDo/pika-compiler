        ...
        PushI        1                         
        Or                                     
        JumpTrue     -print-boolean-6500-true  
        PushD        $boolean-false-string     
        Jump         -print-boolean-6500-join  
        Label        -print-boolean-6500-true  
        PushD        $boolean-true-string      
        Label        -print-boolean-6500-join  
        PushD        $print-format-boolean     
        Printf                                 
        PushD        $print-format-newline     
        Printf                                 
        ...
        PushI        1                         
        Or                                     
        JumpTrue     -print-boolean-6502-true  
        PushD        $boolean-false-string     
        Jump         -print-boolean-6502-join  
        Label        -print-boolean-6502-true  
        PushD        $boolean-true-string      
        Label        -print-boolean-6502-join  
        PushD        $print-format-boolean     
        Printf                                 
        PushD        $print-format-newline     
        Printf                                 
        ...
        PushI        0                         
        Or                                     
        JumpTrue     -print-boolean-6504-true  
        PushD        $boolean-false-string     
        Jump         -print-boolean-6504-join  
        Label        -print-boolean-6504-true  
        PushD        $boolean-true-string      
        Label        -print-boolean-6504-join  
        PushD        $print-format-boolean     
        Printf                                 
        PushD        $print-format-newline     
        Printf                                 
        ...
        PushI        0                         
        Or                                     
        JumpTrue     -print-boolean-6506-true  
        PushD        $boolean-false-string     
        Jump         -print-boolean-6506-join  
        Label        -print-boolean-6506-true  
        PushD        $boolean-true-string      
        Label        -print-boolean-6506-join  
        PushD        $print-format-boolean     
        Printf                                 
        PushD        $print-format-newline     
        Printf                                 
